...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dnsc_audit_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `audit_checklist` (
  ...
  `audit_checklist_status` enum('PENDING','DONE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING'
...
insert  into `audit_plans`(`audit_plan`,`type`,`introduction`,`audit_objectives`,`reference_standard`,`audit_methodologies`,`year`,`status`) values 
