...
MySQL - 10.11.10-MariaDB : Database - u783871548_sunbeam_appdb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`u783871548_sunbeam_appdb` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
(238,'ENR51F06B33E62AC','JOGGING PANTS (LARGE)','OTHERS','410','PAYMENT'),
(239,'ENR51F06B33E62AC','REGISTRATION','MAIN','1000','PAYMENT'),
(240,'ENR51F06B33E62AC','TUITION','MAIN','6000','PAYMENT'),
(241,'ENR51F06B33E62AC','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(242,'ENR51F06B33E62AC','ID AND INSURANCE','MAIN','380','PAYMENT'),
(243,'ENR51F06B33E62AC','BOOKS','MAIN','5495','PAYMENT'),
(244,'ENR51F06B33E62AC','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(245,'ENRD3F64DD722246','REGISTRATION','MAIN','1000','PAYMENT'),
(246,'ENRD3F64DD722246','TUITION','MAIN','6000','PAYMENT'),
(247,'ENRD3F64DD722246','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(248,'ENRD3F64DD722246','ID AND INSURANCE','MAIN','380','PAYMENT'),
(249,'ENRD3F64DD722246','BOOKS','MAIN','5495','PAYMENT'),
(250,'ENRD3F64DD722246','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(251,'ENRC2110BC03E64E','REGISTRATION','MAIN','1000','PAYMENT'),
(252,'ENRC2110BC03E64E','TUITION','MAIN','6000','PAYMENT'),
(253,'ENRC2110BC03E64E','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(254,'ENRC2110BC03E64E','BOOKS','MAIN','6000','PAYMENT'),
(255,'ENRC2110BC03E64E','MISCELLANEOUS FEE','MAIN','7000','PAYMENT'),
(256,'ENRC2110BC03E64E','ID AND INSURANCE','MAIN','380','PAYMENT'),
(257,'ENR7CA1D13C8FA81','JOGGING PANTS(SMALL)','OTHERS','350','PAYMENT'),
(258,'ENR7CA1D13C8FA81','REGISTRATION','MAIN','1000','PAYMENT'),
(259,'ENR7CA1D13C8FA81','TUITION','MAIN','6000','PAYMENT'),
(260,'ENR7CA1D13C8FA81','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(261,'ENR7CA1D13C8FA81','BOOKS','MAIN','6000','PAYMENT'),
(262,'ENR7CA1D13C8FA81','MISCELLANEOUS FEE','MAIN','7000','PAYMENT'),
(263,'ENR7CA1D13C8FA81','ID AND INSURANCE','MAIN','380','PAYMENT'),
(264,'ENR7CA1D13C8FA81','JOGGING PANTS(SMALL)','OTHERS','350','PAYMENT'),
(265,'ENR2AC45944F5ABA','CHOREOGRAPHER FIELD DEMO','OTHERS','500','PAYMENT'),
(266,'ENR2AC45944F5ABA','REGISTRATION','MAIN','1000','PAYMENT'),
(267,'ENR2AC45944F5ABA','TUITION','MAIN','6000','PAYMENT'),
(268,'ENR2AC45944F5ABA','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(269,'ENR2AC45944F5ABA','BOOKS','MAIN','6000','PAYMENT'),
(270,'ENR2AC45944F5ABA','MISCELLANEOUS FEE','MAIN','7000','PAYMENT'),
(271,'ENR2AC45944F5ABA','ID AND INSURANCE','MAIN','380','PAYMENT'),
(272,'ENR2AC45944F5ABA','JOGGING PANTS(SMALL)','OTHERS','350','PAYMENT'),
(273,'ENR07FB350C3D27A','REGISTRATION','MAIN','1000','PAYMENT'),
(274,'ENR07FB350C3D27A','TUITION','MAIN','6000','PAYMENT'),
(275,'ENR07FB350C3D27A','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(276,'ENR07FB350C3D27A','ID AND INSURANCE','MAIN','380','PAYMENT'),
(277,'ENR07FB350C3D27A','BOOKS','MAIN','5495','PAYMENT'),
(278,'ENR07FB350C3D27A','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(279,'ENR3ACE2EBE58FA0','REGISTRATION','MAIN','1000','PAYMENT'),
(280,'ENR3ACE2EBE58FA0','TUITION','MAIN','6000','PAYMENT'),
(281,'ENR3ACE2EBE58FA0','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(282,'ENR3ACE2EBE58FA0','ID AND INSURANCE','MAIN','380','PAYMENT'),
(283,'ENR3ACE2EBE58FA0','BOOKS','MAIN','5495','PAYMENT'),
(284,'ENR3ACE2EBE58FA0','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(285,'ENR02BC2CA3FE933','REGISTRATION','MAIN','1000','PAYMENT'),
(286,'ENR02BC2CA3FE933','TUITION','MAIN','6000','PAYMENT'),
(287,'ENR02BC2CA3FE933','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(288,'ENR02BC2CA3FE933','ID AND INSURANCE','MAIN','380','PAYMENT'),
(289,'ENR02BC2CA3FE933','BOOKS','MAIN','5495','PAYMENT'),
(290,'ENR02BC2CA3FE933','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(291,'ENRF845947319D18','REGISTRATION','MAIN','1000','PAYMENT'),
(292,'ENRF845947319D18','TUITION','MAIN','6000','PAYMENT'),
(293,'ENRF845947319D18','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(294,'ENRF845947319D18','ID AND INSURANCE','MAIN','380','PAYMENT'),
(295,'ENRF845947319D18','BOOKS','MAIN','5495','PAYMENT'),
(296,'ENRF845947319D18','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(297,'ENR28A8B2E4F8A63','REGISTRATION','MAIN','1000','PAYMENT'),
(298,'ENR28A8B2E4F8A63','TUITION','MAIN','6000','PAYMENT'),
(299,'ENR28A8B2E4F8A63','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(300,'ENR28A8B2E4F8A63','ID AND INSURANCE','MAIN','380','PAYMENT'),
(301,'ENR28A8B2E4F8A63','BOOKS','MAIN','5495','PAYMENT'),
(302,'ENR28A8B2E4F8A63','MISCELLANEOUS FEE','MAIN','5350','PAYMENT'),
(303,'ENRA1EA5410495D2','REGISTRATION','MAIN','1000','PAYMENT'),
(304,'ENRA1EA5410495D2','TUITION','MAIN','6000','PAYMENT'),
(305,'ENRA1EA5410495D2','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(306,'ENRA1EA5410495D2','BOOKS','MAIN','6000','PAYMENT'),
(307,'ENRA1EA5410495D2','MISCELLANEOUS FEE','MAIN','7000','PAYMENT'),
(308,'ENRA1EA5410495D2','ID AND INSURANCE','MAIN','380','PAYMENT'),
(309,'ENR254D85C83D568','REGISTRATION','MAIN','1000','PAYMENT'),
(310,'ENR254D85C83D568','TUITION','MAIN','6000','PAYMENT'),
(311,'ENR254D85C83D568','ELECTRIC SUBSIDY','MAIN','3800','PAYMENT'),
(312,'ENR254D85C83D568','ID AND INSURANCE','MAIN','380','PAYMENT'),
(313,'ENR254D85C83D568','BOOKS','MAIN','5495','PAYMENT'),
(314,'ENR254D85C83D568','MISCELLANEOUS FEE','MAIN','5350','PAYMENT');
...
(16,'Grade 1','REGISTRATION','MAIN','1000','ACTIVE'),
...
(23,'Grade 1','CHOREOGRAPHER FIELD DEMO','OTHERS','','ACTIVE'),
...
('LRN40559200000026','Michael','Bayron','Virtudazo','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CARMEN','Cebulano','Purok 3','SY03FBB1599C61C','2002-05-04','DAVAO CITY','Male',NULL,'Roman Catholic','','','','','','','','','','','ALthea','Bayron','Galorio','(+63) 9850623148','BUSINESSMAN',NULL,NULL,NULL,NULL,NULL,'','','','',26,'USR-a8ef4c1ca89b5-241205','ENR28A8B2E4F8A63'),
('LRN40559200000027','Brian Rey','Galo','Galorio','','AUTONOMOUS REGION IN MUSLIM MINDANAO (ARMM)','BASILAN','CITY OF LAMITAN','Arco','Purok 3','SY03FBB1599C61C','2002-05-04','DAVAO CITY','Male',NULL,'Roman Catholic','','','','','','','','','','','michael','Oh','Caballes','(+63) 9850623148','GUARDIAN',NULL,NULL,NULL,NULL,NULL,'','','','',27,'USR-a8ef4c1ca89b5-241205','ENRA1EA5410495D2'),
('LRN40559200000028','Darren Kent','Abenion','Tusias','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Salvacion','Purok 3, Salvacion, Panabo City','SY03FBB1599C61C','2002-04-27','Tagum City, Davao Del Norte','Male',NULL,'Catholic','','','','','','','','','','','Dasha','Taran','Taran','(+63) 9770985031','Chief Executive Officer',NULL,NULL,NULL,NULL,NULL,'','','','',28,'USR-a8ef4c1ca89b5-241205','ENR254D85C83D568');
...
(157,'SUBJ808FA8B46244D','SCHED17E0AEA934BCB','LRN40559200000026','ADV37A37989430D0',NULL,NULL,NULL,NULL,NULL,NULL),
...
('TDEC9218A0D6B5','Ellen Joy','S','Boctoto','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','J.P. Laurel','PUROK 2','BSIT','MIT','1990-05-05','Male','sakmaestro@gmail.com','(+63) 9912021547'),
('TE73F9F3CE2494','Japhet','V','Tolentino','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Cacao','PUROK 5','BS Education Major in English','Master in Secondary Education','1990-01-01','Male','shernancy@gmail.com','(+63) 9912021547'),
('TDFDB936CDE413','Craizia Jane','M','Del Rosario','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Cacao','PUROK 3','BS EDUC','','1984-05-05','Female','monkeygarp@gmail.com','(+63) 9912021900'),
('T965A22ED6A3A7','Kaloy','','Loie','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Buenavista','PUROK 3','BS Educ in Math','','1976-09-21','Male','kaloyloie@gmail.com','(+63) 0991020222'),
('T158F0C1C96533','Ailyn','S','Exclamado','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Cacao','PUROK 1','BS in Education','','1990-01-01','Male','gifty_joy@yopmail.com','(+63) 1231231231'),
('T392DF740696AD','Leah','M','Araneta ','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','New Visayas','Gentiles Subd','BS IN EDUCATION','Master in Education','1965-01-08','Female','leah_araneta@yopmail.com','(+63) 9297501250'),
('T699EBCDE12880','Gifty Joy','Gencianos','Pandio','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Gredu (Pob.)','Purok Maharlika','BS IN EDUCATION','Master in Education','1996-10-08','Female','gifty_joy@yopmail.com','(+63) 9122700871'),
('TFAA14AD1015E8','Charlene','Catalan','Serina','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Sindaton','Purok 3','BS IN EDUCATION','Master in Education','1996-01-29','Female','charlene_serina@yopmail.com','(+63) 9518444498'),
('T6483BBFF587BC','Corie Anne Joy','Camino','Uypala','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CARMEN','Ising (Pob.)','Purok 13','BS IN EDUCATION','Master in Education','1986-03-13','Female','corie_anne@yopmail.com','(+63) 9631908956'),
('TEBB45FA054403','Aniegyn','P','Advincula','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Kauswagan','PUROK 5','BS IN EDUCATION','Master in Education','1986-05-21','Female','aniegyn_advincula@yopmail.com','(+63) 0950581374'),
('T499692CC26249','Angelyn','P','Comendador','','REGION XI (DAVAO REGION)','DAVAO DEL NORTE','CITY OF PANABO','Datu Abdul Dadia','Purok 3','BS in Education','Master in Education','1980-05-02','Female','angelyn@yopmail.com','(+63) 9850623789');
...
('T392DF740696AD','leah_araneta@yopmail.com','$2y$10$Gj5SmsU0Sai8oEbxkW.0FOllv/amYqmumgbva./pyFqC7v6qhMIoi','teacher','active','Leah Araneta ',NULL,NULL),
...
('TE73F9F3CE2494','japhet@yopmail.com','$2y$10$orztpllakLvLF6TYdCnq.OTO3hjzHo9QAONfauHlWRzJI39BZhYpO','teacher','active','Japhet Tolentino',NULL,NULL),
('TEBB45FA054403','aniegyn_advincula@yopmail.com','$2y$10$6UvUE4pZLhrGsFIlDNQYYecKuAF4mGQrmQOf7Iuf/7ibhQkzweJOC','teacher','active','Aniegyn Advincula',NULL,NULL),
