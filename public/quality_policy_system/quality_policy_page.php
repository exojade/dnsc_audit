<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <!-- <div class="col-sm-6">
            <h1>quality_policys</h1>
          </div> -->
          <div class="col-sm-12">
            <ol class="breadcrumb" id="breadcrumb" style="font-size: 180%; color: #000;">
              <li class="breadcrumb-item"><a href="#" onclick="loadFiles('')">quality_policy</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    ...
    function updateBreadcrumb(folder) {
        ...
        let breadcrumbHtml = `<li class="breadcrumb-item"><a href="#" onclick="loadFiles('')">Quality Policy</a></li>`;
...
$(document).on("submit", "#fileUploadForm", function(event) {
    ...
    $.ajax({
        url: 'quality_policy',  // Adjust this to your PHP script's URL
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
...
function moveToFolder(folder) {
    ...
    $.ajax({
        url: 'quality_policy', // Your server-side PHP file
        type: 'POST',
        data: {
