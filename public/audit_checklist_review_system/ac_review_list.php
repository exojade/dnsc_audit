...
var datatable = 
            $('#ajax_datatable').DataTable({
                ...
                'ajax': {
                    'url':'audit_checklist_review',
                     'type': "POST",
                     "data": function (data){
                        data.action = "ac_review_list"
                     }
                },
                'columns': [
    ...
    { data: 'audit_checklist_status', "orderable": false },
  ...
  $('.selectFilter').on('change', function() {
    ...
    var statusSelect = $('#statusSelect').val() || "";
            datatable.ajax.url('audit_checklist_review?action=ac_review_list&ap=' + apSelect+'&status='+statusSelect).load();
  });
