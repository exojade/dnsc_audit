        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb" id="breadcrumb" style="font-size: 180%; color: #000;">
              <li class="breadcrumb-item"><a href="#" onclick="loadFiles('')">mymanuals</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<script>
    ...
    function downloadFile(filePath) {
        ...
        window.location.href = "mymanuals?action=download&file=" + encodedFilePath;
    }
...
$(document).on("submit", "#fileUploadForm", function(event) {
    ...
    $.ajax({
        url: 'mymanuals',  // Adjust this to your PHP script's URL
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
...
function moveToFolder(folder) {
    ...
    $.ajax({
        url: 'mymanuals', // Your server-side PHP file
        type: 'POST',
        data: {
