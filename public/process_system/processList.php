    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-6">
            <a href="#" data-toggle="modal" class="btn btn-success float-right" data-target="#modalAddProcess">Add Process</a>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
      ...
      <div class="modal-dialog">
        <div class="modal-content ">
          <div class="modal-header bg-success">
              <h3 class="modal-title text-center">Add Process</h3>
          </div>
          <div class="modal-body">
              <form class="generic_form_trigger" data-url="process">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="processName" placeholder="Enter Process Name">
                  </div>
                  <hr>
...
<script>
    ...
    $('#modalAssignedArea').on('show.bs.modal', function (e) {
        ...
        $.ajax({
            ...
            data: {
                process_id: rowid, action: "modalAssignedArea"
            },
