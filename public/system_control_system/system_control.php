<?php
    if($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if($_POST["action"] == "create_folder"):
            ...
            $folderPath = $base_path = "file_manager/system_control/".$_POST['folder']; // Get the full folder path
    //  dump($folderPath);
		...
		elseif($_POST["action"] == "access_folder"):
            // phpinfo();
            $base_path = "file_manager/system_control/";
...
elseif($_POST["action"] == "upload"):
    ...
    $target_dir = "file_manager/system_control/" . $current_path; // Define the target directory
    ...
    elseif($_POST["action"] == "get_folder_structure"):
        ...
        $rootDir = 'file_manager/system_control';
        ...
        //         $MyArea["file_manager/system_control//".$row["area_id"]] = $row;
        //     endforeach;
            // dump($MyArea);
    ...
    if(is_dir($folderPath)):
        ...
        if (file_exists($folderPath)) {
			...
			if(!isset($_GET["action"])):
				...
				render("public/system_control_system/system_control_page.php",[
                ]);
			else:
